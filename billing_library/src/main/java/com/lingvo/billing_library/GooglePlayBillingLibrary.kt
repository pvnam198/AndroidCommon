...
import com.lingvo.billing_library.model.PurchaseResponseCode
import com.lingvo.billing_library.model.SaleProductDetail
import com.lingvo.billing_library.model.SaleProductDetail.Companion.toSaleProductDetail
import com.lingvo.billing_library.model.SalePurchase
import com.lingvo.billing_library.model.SalePurchase.Companion.toSalePurchase
...
class GooglePlayBillingLibrary(context: Context) : BillingLibrary {
    ...
    override fun purchase(activity: Activity, saleProductDetail: SaleProductDetail) {
        ...
        val productDetailsParamsList = listOf(
            saleProductDetail.subscriptionOfferDetails?.first()?.let {
